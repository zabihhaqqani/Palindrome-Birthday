...
function clickHandler(e) {
    ...
    if (dob !== "") {
        ...
        if (isPalindrome) {
            ...
            outputMsg.innerText = `Sorry your birthday is not a palindrome \n You missed it by ${ctr} days and the next palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}`
        }
    } else {
        outputMsg.innerText = "Please enter the date of birth"
    }
}
